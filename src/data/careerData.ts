...
export const ROADMAPS: Roadmap[] = [
  ...
  },
  {
    ...
    icon: "Layers",
    summary: "Own the whole product — frontend, backend, and everything between.",
  ...
  },
  {
    ...
    role: "Data Engineer",
    icon: "Database",
    summary: "Build the pipelines and platforms that power analytics and ML.",
    duration: "7–10 months",
    stages: [
  ...
  },
  {
    ...
    icon: "Smartphone",
    summary: "Ship native and cross-platform apps for Android and iOS.",
    duration: "5–8 months",
    stages: [
